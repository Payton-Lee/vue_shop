        ...
        >
          <el-tab-pane label="基本信息" name="0">
            ...
            <el-form-item label="商品分类" prop="goods_cat">
              <!-- props 是配置选项  options是级联选择器的数据绑定-->
              <el-cascader
          ...
          <el-tab-pane label="商品图片" name="3">
            <!-- action 表示图片要上传到的后台API接口地址 -->
            <!-- headers 设置上传的请求头部，对象格式的存储 -->
            <el-upload
              class="upload-demo"
              :action="uploadUrl"
...
export default {
  data() {
    return {
      ...
      // 图片上传组件的headers请求头对象,为每次上传图片提供token认证
      headerObj: {
        // 上传组件没有使用axios进行请求，需要自己指定Authorization值
